...
const Signup = () => {
  ...
  return (
    <div
      className="w-full min-h-screen bg-gray-100 text-white flex flex-col justify-center px-12 sm:px-0 items-center"
      style={{ backgroundColor: "#F9F9F9" }}
    >
      <div className="w-full sm:max-w-md p-8 mx-auto bg-gray-600 rounded-3xl">
